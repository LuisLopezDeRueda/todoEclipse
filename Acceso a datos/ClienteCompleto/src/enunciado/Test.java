...
import enunciado.clients.CiudadErrorException;
import enunciado.clients.CiudadNoEncontradaException;
import enunciado.clients.CiudadesClientImpl;
import enunciado.clients.CiudadesClient;
...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ciudad.setCountryId(null);
			ciudad.setDescripcion("Samarcandaasd");
