...
import RepasoFicheros.Service.CatalogoXMLException;
import RepasoFicheros.Service.Ejercicio12Service;
...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Cat�logo leído con tama�o: " + catalogo.getTamaño());
