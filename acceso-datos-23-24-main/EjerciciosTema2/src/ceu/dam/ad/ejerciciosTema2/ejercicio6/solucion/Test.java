package ceu.dam.ad.ejerciciosTema2.ejercicio6.solucion;

import ceu.dam.ad.ejerciciosTema2.ejercicio6.solucion.clients.CiudadErrorException;
import ceu.dam.ad.ejerciciosTema2.ejercicio6.solucion.clients.CiudadNoEncontradaException;
import ceu.dam.ad.ejerciciosTema2.ejercicio6.solucion.clients.CiudadesClient;
import ceu.dam.ad.ejerciciosTema2.ejercicio6.solucion.clients.CiudadesClientImpl;
...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("\n>>> Test consulta ciudades existentes Caracas-Lancaster-Newcastle:::");
		...
		try {
			...
			System.out.println("Test de borrado erróneo: la ciudad sigue existiendo: " + ciudad);
